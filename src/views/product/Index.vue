                  ...
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                    ...
                    <ul class="color-option">
                      <li v-for="color in filterList.colors">
                        <a @click.prevent = "addColor(color.id)" href="#0" :style="`background: #${color.title}`" class="color-option-single"> <span> {{ color.title }}</span> </a>
                      </li>
                    </ul>
                  </div>
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                        ...
                        <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                          <div class="products-three-single w-100  mt-30">
                            <div class="products-three-single-img"> <a
                              ...
                              </div> <a @click.prevent="addToCart(product.id)" href="cart.html" class="addcart btn--primary style2">
                                Add To Cart </a>
                                ...
                                <div class="row justify-content-between align-items-center">
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="price">
                                        <h2> ${{popupProduct.old_price}} USD <del> ${{popupProduct.price}} USD</del></h2>
                                        <h6> In stuck</h6>
                                      </div>
                ...
                <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                  <ul class="pagination text-center">
                    <li v-if="pagination.current_page !== 1" class="next">
                      <a @click.prevent="getProducts(pagination.current_page -1)" href="#0"><i class="flaticon-left-arrows" aria-hidden="true"></i></a></li>
...
">
                    ...
                    <li v-if="pagination.current_page !== pagination.last_page" class="next">
                      <a @click.prevent="getProducts(pagination.current_page +1)" href="#0"><i class="flaticon-next-1" aria-hidden="true"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
